...
When we trim the reads with \emph{trim_galore} before aligning, the result is shown below in Supplemental Figure 2. We report the percent of reads aligned relative
...
difference is very small for \texit{bwa-meth}.
